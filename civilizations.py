...
def image_zoom_n_interpolation(steps, scale_by,prompt_text_start, prompt_text_end, x = 20,y = 11):
    ...
    prompt["7"]["inputs"]["text"] = "text, watermark, empty, boring"
    prompt["13"]["inputs"]["x"] = x  #34 for centered zoom at 1.05 and [1344,768]
    prompt["13"]["inputs"]["y"] = y  #19 for centered zoom
    prompt["14"]["inputs"]["scale_by"] = scale_by
...
prompt_text = "cave painting of people hunting bison and other animals"
generated_image = image_watch(generated_image)
copy_and_rename_image(generated_image,path_to_load_image,"processed.png")
...
while(True):
    p1 = prompt_text
    p2 = "ancient ceramic vase decorated with ancient greek city"
    image_zoom_n_interpolation(180,1.03,p1,p2)

    p1 = p2
    p2 = "roman relief showing life in rome"
    image_zoom_n_interpolation(180,1.03,p1,p2)

    #image_zoom(320, 1.03, p2)

    p1 = p2
    p2 = "painting of hieronymus bosh showing everyday life in medieval europe"
    image_zoom_n_interpolation(180,1.03,p1,p2)

    p1 = p2
    p2 = "painting of rubens showing everyday life in renaissance europe, pier, ship, market"
    image_zoom_n_interpolation(180,1.03,p1,p2)

    #image_zoom(320, 1.03, p2)

    p1 = p2
    p2 = "monochrome sepia photography showing everyday life in victorian era london"
    image_zoom_n_interpolation(180,1.03,p1,p2)

    
    p1 = p2
    p2 = "analog photography showing everyday life in modern warsaw"
    image_zoom_n_interpolation(180,1.03,p1,p2)


    p1 = p2
    p2 = "image of futuristic city, full of people living, 3d render"
    image_zoom_n_interpolation(180,1.03,p1,p2)

    p1 = p2
    p2 = "image of futuristic city on a brink of doom, full of people living, 3d render"
    image_zoom_n_interpolation(180,1.03,p1,p2)

    p1 = p2
    p2 = "image of futuristic city after apocalypse, full of people living, 3d render, postapo"
    image_zoom_n_interpolation(180,1.03,p1,p2)

    p1 = p2
    p2 = "image of futuristic city after apocalypse overgrowing with lush vegetation, full of people living, 3d render, postapo"
    image_zoom_n_interpolation(180,1.03,p1,p2)
