...
embed_IPA_lora_out = 'E:\\sagAI\\video for comfy\\video-for-comfy\\embed IPA 2lora outpaint.json' #contains IPA, 2 loras, ReActor, outpainting
embed_IPA_lora_in = 'E:\\sagAI\\video for comfy\\video-for-comfy\\embed IPA 2lora zoom.json' #contains IPA, 2 loras, ReActor, zoom in
lora_zoom_out = 'E:\\sagAI\\video for comfy\\video-for-comfy\\zoomout 2loras interpolation.json' #contains 2 loras, outpainting
lora_zoom_in = 'E:\\sagAI\\video for comfy\\video-for-comfy\\zoomin 2loras interpolation.json' #contains 2 loras, zoom in
...
def image_lora_interpolation_in(steps, scale_by,prompt_text_start, prompt_text_end, x = 25,y = 11):
    """zooms in one particular direction, 
    interpolates between prompts,
    @steps: how many steps of this stransition
    @scale_by: scale factor
    @prompt_text_start: prompt to start with
    @prompt_text_end: prompt to end with
    ...
    global generated_image
    prompt1 = prompt_prepare(lora_zoom_in, scale_by,prompt_text_start, prompt_text_end, negative, x = x,y = y)
    steps_done = 0
    while(steps>steps_done):
        steps_done +=1
        prompt1["21"]["inputs"]["conditioning_to_strength"] = steps_done/steps
        ...
        queue_prompt(prompt1)
        #prompt["3"]["inputs"]["denoise"] = (denoise - (0.6/(1 + (steps_done % 30))))
        generated_image = image_watch(generated_image)
        copy_and_rename_image(generated_image, path_to_load_image, "processed.png")

def image_lora_interpolation_out(steps, scale_by,prompt_text_start, prompt_text_end, x = 25,y = 11):
    """zooms in one particular direction, 
    interpolates between prompts,
    @steps: how many steps of this stransition
    @scale_by: scale factor
    ...
    global generated_image
    prompt1 = prompt_prepare(lora_zoom_out, scale_by,prompt_text_start, prompt_text_end, negative, x = x,y = y)
    steps_done = 0
    while(steps>steps_done):
        steps_done +=1
        prompt1["21"]["inputs"]["conditioning_to_strength"] = steps_done/steps
...
standard_steps = 120
standard_steps_hold = 360
scale_up_factor = 1.03
denoise = 0.5 #denoise of latent image
...
r1 = "70s dark fantasy illustration side_view of wizards walking in underwater cave. surrounded by bioluminescent creatures, d_far, ais-spirals"
r2 = "70s dark fantasy illustration side_view of wizards walking in magic forest. surrounded by bioluminescent creatures, d_far, ais-spirals"
r3 = "70s dark fantasy illustration side_view of wizards falling into black hole. surrounded by bioluminescent creatures, d_far, ais-spirals"
r4 = "70s dark fantasy illustration side_view of wizards sitting in the meadow. surrounded by bioluminescent creatures, d_far, ais-spirals"
r5 = "70s dark fantasy illustration side_view of wizards showing off magic trics. surrounded by bioluminescent creatures, d_far, ais-spirals"
r6 = "70s dark fantasy illustration side_view of wizards sitting in train. surrounded by bioluminescent creatures, d_far, ais-spirals"
r7 = "70s dark fantasy illustration side_view of wizards smoking cigarettes. surrounded by bioluminescent creatures, d_far, ais-spirals"
image_lora_interpolation_in(4,scale_up_factor,r1,r1)
image_lora_interpolation_out(4,scale_up_factor,r1,r1)
while(True):
    image_lora_interpolation_in(standard_steps_hold,scale_up_factor,r1,r1)
    image_lora_interpolation_in(standard_steps,scale_up_factor,r1,r2)
    image_lora_interpolation_in(standard_steps_hold,scale_up_factor,r2,r2)
    image_lora_interpolation_in(standard_steps,scale_up_factor,r2,r3)
    image_lora_interpolation_in(standard_steps_hold,scale_up_factor,r3,r3)
    image_lora_interpolation_in(standard_steps,scale_up_factor,r3,r4)
    image_lora_interpolation_in(standard_steps_hold,scale_up_factor,r4,r4)
    image_lora_interpolation_in(standard_steps,scale_up_factor,r4,r5)
    image_lora_interpolation_in(standard_steps_hold,scale_up_factor,r5,r5)
    image_lora_interpolation_in(standard_steps,scale_up_factor,r5,r6)
    image_lora_interpolation_in(standard_steps_hold,scale_up_factor,r6,r6)
    image_lora_interpolation_in(standard_steps,scale_up_factor,r6,r7)
    image_lora_interpolation_in(standard_steps_hold,scale_up_factor,r7,r7)
    image_lora_interpolation_in(standard_steps,scale_up_factor,r7,r1)
    image_lora_interpolation_out(standard_steps_hold,scale_up_factor,r1,r1)
    image_lora_interpolation_out(standard_steps,scale_up_factor,r1,r2)
    image_lora_interpolation_out(standard_steps_hold,scale_up_factor,r2,r2)
    image_lora_interpolation_out(standard_steps,scale_up_factor,r2,r3)
    image_lora_interpolation_out(standard_steps_hold,scale_up_factor,r3,r3)
    image_lora_interpolation_out(standard_steps,scale_up_factor,r3,r4)
    image_lora_interpolation_out(standard_steps_hold,scale_up_factor,r4,r4)
    image_lora_interpolation_out(standard_steps,scale_up_factor,r4,r5)
    image_lora_interpolation_out(standard_steps_hold,scale_up_factor,r5,r5)
    image_lora_interpolation_out(standard_steps,scale_up_factor,r5,r6)
    image_lora_interpolation_out(standard_steps_hold,scale_up_factor,r6,r6)
    image_lora_interpolation_out(standard_steps,scale_up_factor,r6,r7)
    image_lora_interpolation_out(standard_steps_hold,scale_up_factor,r7,r7)
    image_lora_interpolation_out(standard_steps,scale_up_factor,r7,r1)
